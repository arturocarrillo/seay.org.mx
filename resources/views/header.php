    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="https://seay.org.mx/about-1-main.php">Antecedentes</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https://seay.org.mx/about-2-main.php">¿Quienes somos?</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https://seay.org.mx/about-3-main.php">Integrantes</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https://seay.org.mx/directory-main.php">Directorio</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="https://seay.org.mx/news-main.php">Comunicados</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https://seay.org.mx/gallery-main.php">Galeria</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https://seay.org.mx/learning-main.php">Lectura Recomendada</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https://seay.org.mx/notice-of-privacy-main.php">Avisos de Privacidad</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" target="_blank" href="https://www.seay.org.mx/revista-main.php">Revista</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https://seay.org.mx/alliances-main.php">Alianzas</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="https://seay.org.mx/mq-main.php">Mecanismo de Queja</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="https://seay.org.mx/ut-seay-main.php">Unidad de Transparencia</a>
      </li>
    </ul>
